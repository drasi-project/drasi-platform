...
public class SourceUpdate extends SourceChange {
     ...
     */
    public SourceUpdate(String id, long tsNS, JsonNode properties, Map<String, Object> metadata, List<String> labels, long sourceTsNS, long sequenceNumber) {
        super(id, tsNS, properties, metadata, labels, sourceTsNS, sequenceNumber);
     ...
     */
    public SourceUpdate(String id, long tsNS, JsonNode properties, Map<String, Object> metadata, List<String> labels, long sourceTsNS, long sequenceNumber, String startId, String endId) {
        super(id, tsNS, properties, metadata, labels, sourceTsNS, sequenceNumber, startId, endId);
    }
}
