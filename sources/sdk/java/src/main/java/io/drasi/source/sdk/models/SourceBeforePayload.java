...
public class SourceBeforePayload {
    private AfterClass before;
    private SourceClass source;

    public AfterClass getBefore() { return before; }
    public void setBefore(AfterClass value) { this.before = value; }
