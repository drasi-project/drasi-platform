...
public class SourceInsert extends SourceChange {
     ...
     */
    public SourceInsert(String id, long tsNS, JsonNode properties, Map<String, Object> metadata, List<String> labels, long sourceTsNS, long sequenceNumber) {
     ...
     */
    public SourceInsert(String id, long tsNS, JsonNode properties, Map<String, Object> metadata, List<String> labels, long sourceTsNS, long sequenceNumber, String startId, String endId) {
