...
Follow the [Getting Started tutorial](https://drasi.io/drasi-kubernetes/getting-started/) and try out Drasi for Kubernetes. The tutorial will lead you through:
