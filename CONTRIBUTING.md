...
- [See "good first issues"](https://github.com/drasi-project/drasi-platform/issues?q=is:issue+is:open+label:%22good+first+issue%22) 
...
- [Contribute to the Drasi core libraries](https://github.com/drasi-project/drasi-core)
...
- Please start by [choosing an existing issue](https://github.com/drasi-project/drasi-platform/issues), or [opening an issue](https://github.com/drasi-project/drasi-platform/issues/new/choose) to work on.
...
For more information see [CODE_OF_CONDUCT.md](https://github.com/drasi-project/drasi-platform/blob/main/CODE_OF_CONDUCT.md)
