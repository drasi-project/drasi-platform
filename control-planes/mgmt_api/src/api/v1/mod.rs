...
macro_rules! v1_crud_api {
  ($domain_service:ty, $spec_dto:ty, $status_dto:ty $(, $additional_route:expr ),* ) => {
    ...
    use super::models::{ResourceDto, ResourceProviderDto, ReadyWaitParams};
...
pub mod source_provider_handlers {
    use crate::{
        ...
        domain::resource_services::SourceProviderDomainService,
    };
...
pub mod reaction_provider_handlers {
    use crate::{
        ...
        domain::resource_services::ReactionProviderDomainService,
    };
