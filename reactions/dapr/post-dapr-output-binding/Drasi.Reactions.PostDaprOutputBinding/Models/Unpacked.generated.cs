...
namespace Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked
{
    using System;
    ...
    public partial class ChangeNotification
    {
        public static ChangeNotification FromJson(string json) => JsonSerializer.Deserialize<ChangeNotification>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class ChangePayload
    {
        public static ChangePayload FromJson(string json) => JsonSerializer.Deserialize<ChangePayload>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class ChangeSource
    {
        public static ChangeSource FromJson(string json) => JsonSerializer.Deserialize<ChangeSource>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class ControlPayload
    {
        public static ControlPayload FromJson(string json) => JsonSerializer.Deserialize<ControlPayload>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class ControlSignalNotification
    {
        public static ControlSignalNotification FromJson(string json) => JsonSerializer.Deserialize<ControlSignalNotification>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class Notification
    {
        public static Notification FromJson(string json) => JsonSerializer.Deserialize<Notification>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public class Op
    {
        public static OpEnum FromJson(string json) => JsonSerializer.Deserialize<OpEnum>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class ReloadHeader
    {
        public static ReloadHeader FromJson(string json) => JsonSerializer.Deserialize<ReloadHeader>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public partial class ReloadItem
    {
        public static ReloadItem FromJson(string json) => JsonSerializer.Deserialize<ReloadItem>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public class Versions
    {
        public static VersionsEnum FromJson(string json) => JsonSerializer.Deserialize<VersionsEnum>(json, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ChangeNotification self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ChangePayload self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ChangeSource self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ControlPayload self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ControlSignalNotification self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this Notification self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this OpEnum self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ReloadHeader self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ReloadItem self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
        public static string ToJson(this VersionsEnum self) => JsonSerializer.Serialize(self, Drasi.Reactions.PostDaprOutputBinding.Models.Unpacked.Converter.Settings);
    }
