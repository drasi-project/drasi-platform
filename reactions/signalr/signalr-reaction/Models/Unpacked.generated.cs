...
namespace Drasi.Reactions.SignalR.Models.Unpacked
{
    ...
    public partial class ChangeNotification
    {
        public static ChangeNotification FromJson(string json) => JsonSerializer.Deserialize<ChangeNotification>(json, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
    }

    public partial class ChangePayload
    {
        public static ChangePayload FromJson(string json) => JsonSerializer.Deserialize<ChangePayload>(json, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
    }

    public partial class ChangeSource
    {
        public static ChangeSource FromJson(string json) => JsonSerializer.Deserialize<ChangeSource>(json, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
    }

    public partial class ControlPayload
    {
        public static ControlPayload FromJson(string json) => JsonSerializer.Deserialize<ControlPayload>(json, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
    }

    public partial class ControlSignalNotification
    {
        public static ControlSignalNotification FromJson(string json) => JsonSerializer.Deserialize<ControlSignalNotification>(json, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
    }

    public partial class Notification
    {
        public static Notification FromJson(string json) => JsonSerializer.Deserialize<Notification>(json, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
    }
    ...
    {
        public static string ToJson(this ChangeNotification self) => JsonSerializer.Serialize(self, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ChangePayload self) => JsonSerializer.Serialize(self, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ChangeSource self) => JsonSerializer.Serialize(self, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
        public static string ToJson(this ControlPayload self) => JsonSerializer.Serialize(self, Drasi.Reactions.SignalR.Models.Unpacked.Converter.Settings);
