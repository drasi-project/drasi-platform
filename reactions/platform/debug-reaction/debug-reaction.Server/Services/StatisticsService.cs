...
//         private Dictionary<string, List<TimePoint>> _data = new Dictionary<string, List<TimePoint>>()
//         {
//             [IStatisticsService.QueryHostTime] = new List<TimePoint>(),
//             [IStatisticsService.EnqueueTime] = new List<TimePoint>(),
//             [IStatisticsService.ChangeServiceTime] = new List<TimePoint>(),
//             [IStatisticsService.ChangeDispatcherTime] = new List<TimePoint>(),
//         };
