...
// using Dapr.Client;
using Drasi.Reactions.Debug.Models;
using System.Collections.Concurrent;
using System.Text.Json;

namespace Drasi.Reactions.Debug.Services
{
    public class QueryDebugService : BackgroundService, IQueryDebugService
    {
        ...
        public QueryDebugService(IResultViewClient queryApi, IActorProxyFactory actorProxyFactory, string queryDir, string queryContainerId)
        {
