...
class ActorManager {
     ...
     * @returns
     */
    async invoke(actorId, actorMethodName, requestBody) {
    ...
    async fireReminder(actorId, reminderName, requestBody) {
    ...
    async fireTimer(actorId, timerName, requestBody) {
        // @todo: make sure we are remindable
        const requestBodyDeserialized = this.serializer.deserialize(requestBody || Buffer.from(""));
    ...
    async callActorMethod(actorId, actorMethodName, args) {
