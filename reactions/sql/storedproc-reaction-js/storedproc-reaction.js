...
const pubsubName = getConfigValue("PUBSUB", "drasi-pubsub");
const configDirectory = getConfigValue("QueryConfigPath", "/etc/queries");;
...
let storedProcReaction = new DrasiReaction(
  onChangeEvent, 
  {
