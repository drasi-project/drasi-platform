...
`,
	...
	initCommand.Flags().String("dapr-runtime-version", "1.14.5", "Dapr runtime version to install.")
	initCommand.Flags().String("dapr-sidecar-version", "1.14.5", "Dapr sidecar (daprd) version to install.")
